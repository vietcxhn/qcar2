...
bool qcar2_interfaces__msg__motor_commands__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("qcar2_interfaces.msg._motor_commands.MotorCommands", full_classname_dest, 50) == 0);
  }
  qcar2_interfaces__msg__MotorCommands * ros_message = _ros_message;
  {  // motor_names
...
PyObject * qcar2_interfaces__msg__motor_commands__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("qcar2_interfaces.msg._motor_commands");
